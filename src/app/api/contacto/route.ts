...
export async function POST(request: Request) {
  ...
  try {
    ...
    const { error } = await resend.emails.send({
      ...
      to: destinatario,
      subject: `Nuevo mensaje desde la web - Sonrisa Viva`,
      html: `
<!DOCTYPE html>
<html lang="es">
...
<h1 style="margin:0;font-size:22px;font-weight:700;line-height:1.3;">Nuevo mensaje desde la web</h1>
<p style="margin:4px 0 0;font-size:13px;opacity:0.85;">Formulario de contacto — Sonrisa Viva Odontología</p>
</td>
</tr>
...
<a href="tel:${telefono.replace(/[^0-9+]/g, "")}" style="color:#0077B6;text-decoration:none;">${telefono}</a>
</td>
</tr>
<tr>
...
${servicio ? `<tr>
<td style="padding:10px 0;font-weight:600;color:#1a2332;vertical-align:top;font-size:14px;border-top:1px solid #f1f5f9;">Servicio de interés</td>
<td style="padding:10px 0;color:#334155;border-top:1px solid #f1f5f9;">${servicio}</td>
</tr>` : ""}
<tr>
<td style="padding:10px 0;font-weight:600;color:#1a2332;vertical-align:top;font-size:14px;border-top:1px solid #f1f5f9;">Mensaje</td>
<td style="padding:10px 0;color:#334155;border-top:1px solid #f1f5f9;white-space:pre-line;">${mensaje}</td>
</tr>
<tr>
<td style="padding:10px 0;font-weight:600;color:#1a2332;vertical-align:top;font-size:14px;border-top:1px solid #f1f5f9;">Fecha de envío</td>
<td style="padding:10px 0;color:#334155;border-top:1px solid #f1f5f9;">${fechaEnvio}</td>
</tr>
</table>
...
<a href="https://wa.me/${telefono.replace(/[^0-9]/g, "")}" target="_blank" style="color:#ffffff;text-decoration:none;font-size:14px;font-weight:600;">💬 WhatsApp</a>
</td>
</tr>
</table>
</td>
...
<a href="mailto:${email}" style="color:#ffffff;text-decoration:none;font-size:14px;font-weight:600;">📧 Responder</a>
</td>
</tr>
</table>
</td>
...
Este mensaje fue enviado desde el formulario de contacto de Sonrisa Viva Odontología.
</p>
</td>
</tr>
